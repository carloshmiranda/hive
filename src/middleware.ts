...
export const config = {
  matcher: [
    ...
    "/((?!login|api/auth|api/webhooks|api/cron|api/health|api/agents|api/notify|api/backlog|api/dispatch|api/setup|api/settings|api/roadmap|_next/static|_next/image|favicon.ico).*)",
  ],
};
